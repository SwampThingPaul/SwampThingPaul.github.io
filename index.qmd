...
`r paste0("[Google Scholar](https://scholar.google.com/citations?user=MTXcoJYAAAAJ&hl=en) Citations = ",l$total_cites)` <br> `r paste0("H-Index = ",l$h_index)` <br> `r paste0("i10-Index = ",l$i10_index)` <br>
