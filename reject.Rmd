...
```{r pubplot,echo=F,fig.width=6,fig.height=4,fig.align="center",fig.cap="Time series of publication record relative to the number of weeks elaspsed untill final decision. Does not include publication *in-prep*."}
