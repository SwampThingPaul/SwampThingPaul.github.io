...
Motivated by Dr Haushofer, [Dr Melanie Stefan](http://melaniestefan.net/Mela_24Nov2017.pdf), [Dr Auriel Fournier](http://aurielfournier.github.io/rejection/) and others have done the same. I decided to begin documenting my failures as well. This page is organized into three sections including publications, applications to workshops/short-courses, and grants/funding. I likely missed some data in my reconstruction efforts, but this accounts for the major applications and funding oppurtunities from 2014/2015 to current.
