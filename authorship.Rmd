...
knitr::include_graphics("../images/Cooke et al_Fig1.jpg")
```

As suggested above, if co-authors are completely unresponsive it is the lead authors progrative, with input from co-authors to remove unresponsice co-authors. The Committee on Publication Ethics ([COPE](https://publicationethics.org/authorship)), has additional guidance information regarding authorship and ethics. 
