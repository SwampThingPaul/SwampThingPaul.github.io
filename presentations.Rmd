...
- **Julian, P.** 2020. Water Resource Modeling Examples. [`r icon::fa("file-pdf")`](https://swampthingecology.org/slides/modeling/Julian_WaterResourceModeling.html){target="_blank"}

- **Julian, P.** 2020. Multivariate Statistics Tips and Tricks: Intro to PCA. *Newcastle University; Modeling, Evidence and Policy Research Group Seminar.* [`r icon::fa("file-pdf")`](https://swampthingecology.org/slides/PCAWorkshop/Julian_MEP_PCA){target="_blank"}

- **Julian, P.**, K. August, L. Simpson, T.Z. Osborne, D. Surratt. 2019. Hydrologic restoration of a shallow oligotrophic marl wetland. What is the soil telling us? Greater Everglades Ecosystem Restoration Conference. Coral Springs, FL. [`r icon::fa("file-pdf")`](https://SwampThingPaul.github.io/files/pres/20190424_Julianetal_UTS.pdf){target="_blank"} `r icon::fa("youtube")`

- **Julian, P.** 2019. Everglades Restoration and Water Quality. Coccoloba Chapter of the Florida Native Plant Society. Guest Speaker.  [`r icon::fa("file-pdf")`](https://SwampThingPaul.github.io/files/pres/20190321_Everglades.pdf){target="_blank"} [`r icon::fa("youtube")`](https://youtu.be/4YLTccWeVjE){target="_blank"} 

- **Julian, P.** and G. Fletcher. 2018. Don't wave the river red gums goodbye. The role of environmental flows in restoring river water quality and riparian zones along the Wimmera River. Society of Wetland Scientists. Denver, CO. [`r icon::fa("file-pdf")`](https://SwampThingPaul.github.io/files/pres/Julian_Fletcher_Wimmera_EFlows_postSWS.pdf){target="_blank"} [`r icon::fa("youtube")`](https://youtu.be/k5w1YYx5r7o){target="_blank"}
...
- Gerber, S, K. Larios and **P. Julian** 2017. Data Integration and Synthesis Framework for Understanding the Phosphorus Cycling and Reduction Mechanisms in STA Flow-ways. Greater Everglades Ecosystem Restoration, Coral Spring, FL.
